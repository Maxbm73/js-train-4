...
function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  return console.log(String.fromCharCode(code1, code2, code3, code4, code5));
...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  return console.log(String.fromCodePoint(code1, code2, code3, code4));
...
function compareCharCodeAtAndCodePointAt(string, index) {
  let charAtResult = string.charAt(0);
  let atResult = string.at(0);
  let charCodeAtResult = string.charCodeAt(0);
  let codePointAtResult = string.codePointAt(0);
